...
sequelize.sync().then(function() {
  ...
  Item.create({ name: "Rope",      owner: "/cells/1/0", uses: 1, description: "a rope"          }),
  ...
  Item.create({ name: "Hammer",    owner: "/cells/0/1", uses: 1, description: "a hammer for crafting"     }),
  Item.create({ name: "Workbench", owner: "/cells/0/1", uses: 1, description: "a work bench for crafting" }),
  Item.create({ name: "Metal",     owner: "/cells/0/1", uses: 1, description: "metal ingots for crafting" }),
